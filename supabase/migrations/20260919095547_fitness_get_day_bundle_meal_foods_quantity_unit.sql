-- meal_foods' weight_g column became quantity + unit, and gained
-- is_swap_option (see fitness_meal_foods_quantity_unit_and_swap) -- update
-- the nested `foods` jsonb this function builds per meal to match.
